...
public class Roman2Integer {
    ...
    public static void main(String[] args) {
        System.out.println(new Roman2Integer().romanToInt("CMXCIX"));
        System.out.println(new Roman2Integer().intToRoman(999));

        System.out.println(new Roman2Integer().romanToInt("MMMCMXCIX"));
        System.out.println(new Roman2Integer().intToRoman(3999));
